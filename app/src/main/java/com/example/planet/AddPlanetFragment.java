...
public class AddPlanetFragment extends Fragment {
    ...
    private EditText etName,etOrbit,etSize,etHowFarIsItFromEarth;
    ...
    private void connectComponents() {
        ...
        etHowFarIsItFromEarth = getView().findViewById(R.id.etHowFarIsItFromEarthAddPlanetFragment);
        btnAdd = getView().findViewById(R.id.btnAddAddCarFragment);
       btnAdd.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               String name=etName.getText().toString();
               Integer size=Integer.parseInt(etSize.getText().toString());
               Double howFarIsItFromEarth=Double.parseDouble(etHowFarIsItFromEarth.getText().toString());
               Integer orbit=Integer.parseInt(etOrbit.getText().toString());
               if (name.trim().isEmpty()||size==null||orbit==null||howFarIsItFromEarth==null){
                   Toast.makeText(getActivity(), "Some fields are empty!", Toast.LENGTH_LONG).show();
                   return;

               }
               Planet planet= new Planet( name, size,orbit, howFarIsItFromEarth);
